...
+(void)searchSpotify:(NSString *)query withCompletion:(void(^)(NSDictionary *response))completion{
    ...
    NSDictionary *parameters = @{@"q":query,@"type":@"artist,track"};
    ...
    completion(response.body.object[@"artists"]);
